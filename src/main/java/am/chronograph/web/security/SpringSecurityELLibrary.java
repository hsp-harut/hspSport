 ...
 * <br />
 * e.g.<code><br />
 * &lt;ui:component rendered='#{sec:ifAllGranted(&quot;ROLE_USER&quot;)'>
 * blablabal &lt;/ui:component&gt;
 *
...
public class SpringSecurityELLibrary {
	...
	private static Set<String> parseAuthorities(String grantedRoles) {
		Set<String> parsedAuthorities = new TreeSet<>();
	...
	public static boolean ifAllGranted(final String requiredRoles) {
		...
		Set<String> grantedAuthorities = new TreeSet<>();
	 ...
	 *         false otherwise
	 */
	public static boolean ifAnyNotGranted(final String notGrantedRoles) {
		Set<String> parsedAuthorities = parseAuthorities(notGrantedRoles);
		if (parsedAuthorities.isEmpty())
			return true;
